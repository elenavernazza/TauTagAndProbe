...
void Rate()
{
  ...
  TString output = "/grid_mnt/data__data.polcms/cms/vernazza/CMSSW_10_2_1/src/TauTagAndProbe/TauTagAndProbe/test/FindGoodRates/RatesStudies_Run362616";
  ...
  float scaleToLumi = 2.050E34;
  float scale_lumi = 0;

  for(int nt = 0 ; nt < 1 ; ++nt)
    // for(int nt = 0 ; nt < 2 ; ++nt)
    {
      string ntuple = "/EphemeralZeroBias0__Run2022G_Run362616__RAW.root";
